...
contract CrowdFunding {
    ...
    constructor(string memory _id, string memory _name, string memory _description, uint256 _fundGoal){
        funding = Funding(_id, _name, _description, payable(msg.sender), 0, _fundGoal, 0 );
    ...
    function fundProject() public payable noSelfFunds {
        ...
        //Project close
        require(funding.projectStatus != 1, "Project is already close. No more funds are collected");
